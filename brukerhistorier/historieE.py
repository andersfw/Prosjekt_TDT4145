...
def main():
    ...
    # Hjelpemetode for å bestemme om listen lst inneholder parameteter param.
    ...
    insert_into(navn, epost, telefon) # Kjører, etter alle valideringer, metoden som legger inn kunden i databasen
